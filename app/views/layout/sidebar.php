            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item">
                                    ...
                                    <span class="dropdown-item-desc"> <span class="message-user">John Deo</span>
                                        ...
                                        <img alt="image" src="<?php echo base_url('public/img/users/user-2.png'); ?>" class="rounded-circle">
                                        ...
                                        <img alt="image" src="<?php echo base_url('public/img/users/user-5.png'); ?>" class="rounded-circle">
                                    </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                                            Ryan</span> <span class="time messege-text">Your payment invoice is
                                            generated.</span> <span class="time">12 Min Ago</span>
                                    </span>
                                </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                                        <img alt="image" src="<?php echo base_url('public/img/users/user-4.png'); ?>" class="rounded-circle">
                                        ...
                                        <img alt="image" src="<?php echo base_url('public/img/users/user-3.png'); ?>" class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="<?php echo base_url('public/img/user.png'); ?>"
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image" src="<?php echo base_url('public/img/logo.png'); ?>" class="header-logo" /> <span
